              ...
              <v-container fluid class="py-1">
                <v-row dense align="center" justify="space-between">
                  ...
                  <v-col v-if="checkSearch" lg="6" sm="6" cols="12">
                    <v-text-field outlined clearable dense hide-details v-model="txtSearchCode" :label="$t('search_code')"></v-text-field>
                  </v-col>
                  ...
                  <v-col lg="3" sm="6" cols="12">
                    <v-select
                      ...
                      :label="$t('search_view')"
                      :items="searchView"
                      v-model="lstSearchView"></v-select>
                  </v-col>
                  ...
                  <v-col lg="3" sm="6" cols="12" class="py-1">
                    <div class="d-flex justify-end">
                      ...
                      <BaseButton btn_type="text" :btn_text="$t('preview')" @onclick="onPreview()" :disabled="isProcessing" />
                    </div>
                  </v-col>
                </v-row>
              </v-container>
    ...
    async onSearch() {
      if (this.checkSearch == true) {
        ...
        if (this.txtXml_Search == '') {
          this.showNotification('warning', 'Information', this.$t('msg_please_select_a_file'));
          return;
        } else {
