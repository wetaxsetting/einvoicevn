...
import DelarationTransactionDetailsDailog from "@/components/dialog/DelarationTransactionDetailsDailog.vue";
...
export default {
  ...
  components: {
    ...
    "view-einvoice-transaction-details-dialog": DelarationTransactionDetailsDailog
  },
  data: () => ({
    form_date: "",
    to_date: "",
