                ...
                <v-card>
                    <v-row dense>
                        ...
                        <v-col md="6" class="pl-5 pr-5">
                            <BaseDatePicker outlined :pretoday="7" :label="$t('from_date')"
                                v-model="modelSearch.FROM_DATE" />
                        </v-col>
                        <v-col md="6" class="pl-5 pr-5">
                            <BaseDatePicker outlined today :label="$t('to_date')" v-model="modelSearch.TO_DATE" />
                        </v-col>
                        <v-col md="6" class="pl-5 pr-5">
                            <BaseSelect outlined :label="$t('status')" :lstData="dataSearchList.statusList"
                                v-model="modelSearch.STATUS" item-value="CODE" item-text="NAME" />
                        </v-col>
                        <v-col md="6" class="d-flex justify-end pr-4">
                            <BaseButton icon_type="search" :btn_text="$t('search')" :disabled="false"
                                @onclick="onClick('search')" />
                        </v-col>
                        <v-col md="12">
                            <BaseGridView ref="grdSearch" autoresize :header="headerList.grdSearch"
                                sel_procedure="EI_SEL_6095440_01_NC" selectionmode="singlerow" :multiselect="true"
                                :height="limitHeight" :headertype="1" :filter_paras="[
                                    this.modelSearch.COMPANY_PK,
                                    this.modelSearch.FROM_DATE,
                                    this.modelSearch.TO_DATE,
                                    this.modelSearch.STATUS]" @cellClick="onClick('grdSearchClick')" />
                        </v-col>
                            ...
                            <v-row dense>
                                ...
                                <v-col md="7">
                                    <GwFlexBox justify="end">
                                        <BaseButton icon_type="xml" :btn_text="$t('view_xml')"
                            ...
                            <v-row dense>
                                ...
                                <v-col md="4" class="pl-5 pt-1">
                                    <BaseSelect outlined item-value="VAL" item-text="NAME" :label="$t('taxpayer_name')"
                                        :lstData="dataMasterList.companyList" v-model="modelMaster.TEI_COMPANY_PK"
                                        readonly />
                                </v-col>
                                <v-col md="4" class="pl-5 pt-1">
                                    <BaseSelect outlined :label="$t('tax_office')" v-model="modelMaster.MCQTQLY"
                                ...
                                <v-col md="4" class="pl-5 pt-1 pr-5">
                                    <BaseSelect outlined :label="$t('registration_form')" v-model="modelMaster.HTHUC"
                                        :lstData="dataMasterList.registrationFormList" item-text="NAME" item-value="CODE" />
                                </v-col>
                                <!--  -->
                                ...
                                <v-col md="2" class="pl-5 pt-1 pb-2">
                                    <BaseDatePicker outlined today :label="$t('register_day')" start
                                        v-model="modelMaster.NLAP" />
                                </v-col>
                            </v-row>
                                ...
                                <v-col md="12">
                                    <v-card v-scroll.self="onScroll" class="overflow-y-auto" :max-height="scroll_height">
                                                ...
                                                <v-row dense>
                                                    <v-col md="4">
                                                        <v-sheet class="d-flex align-center">
                                                            <BaseCheckbox v-model="modelMaster.CMA" true-value="1"
                                                                false-value="0" :label="$t('Có mã của Cơ Quan Thuế')"
                                                                color="#000" />
                                                        </v-sheet>
                                                    </v-col>
                                                    <v-col md="4">
                                                        <v-sheet class="d-flex align-center">
                                                            <BaseCheckbox v-model="modelMaster.KCMA" true-value="1"
                                                                false-value="0"
                                                                :label="$t('Không có mã của Cơ Quan Thuế')" />
                                                        </v-sheet>
                                                    </v-col>
                                                    <v-col md="4">
                                                        <v-sheet class="d-flex align-center">
                                                            <BaseCheckbox v-model="modelMaster.CMTMTTIEN" true-value="1"
                                                                false-value="0"
                                                                :label="$t('Hóa đơn có máy khỏi tạo từ máy tính tiền')"
                                                                color="#000" v-if="modelMaster.PBAN == '2.0.1'" />
                                                        </v-sheet>
                                                    </v-col>
                                                </v-row>
                                            </v-col>
                                        ...
                                        <v-row dense>
                                            ...
                                            <v-col md="6">
                                                <v-sheet class="d-flex align-center pr-5">
                                                    <BaseCheckbox v-model="modelMaster.NNTDBKKHAN" true-value="1"
                                                        false-value="0"
                                                        :label="$t('Doanh nghiệp nhỏ và vừa, hợp tác xã, hộ, cá nhân kinh doanh tại địa bàn có điều kiện kinh tế xã hội khó khăn, địa bàn có điều kiện kinh tế xã hội đặc biệt khó khăn')" />
                                                </v-sheet>
                                            </v-col>
                                            <v-col md="5">
                                                <v-sheet class="d-flex align-center pr-5">
                                                    <BaseCheckbox v-model="modelMaster.NNTKTDNUBND" color="#000000"
                                                        true-value="1" false-value="0"
                                                        :label="$t('Doanh nghiệp nhỏ và vừa khác theo đề nghị của Ủy ban nhân dân tỉnh, thành phố trực thuộc trung ương gửi Bộ tài chính trừ doanh nghiệp hoạt động tại các khu kinh tế khu công nghiệp, khu công nghệ cao')" />
                                                </v-sheet>
                                            </v-col>
                                            <v-col md="1" v-if="false"></v-col>
                                            <v-col md="6" v-if="false">
                                                <v-sheet class="d-flex align-center pr-5">
                                                    <BaseCheckbox v-model="modelMaster.CDLTTDCQT" true-value="1"
                                                        false-value="0"
                                            ...
                                            <v-col md="5" v-if="false">
                                                <v-sheet class="d-flex align-center pr-5">
                                                    <BaseCheckbox v-model="modelMaster.CDLQTVAN" color="#000000"
                                                        true-value="1" false-value="0"
                                        ...
                                        <v-row dense>
                                            ...
                                            <v-col md="6">
                                                <v-sheet class="d-flex align-center">
                                                    <BaseCheckbox v-model="modelMaster.CDDU" true-value="1" false-value="0"
                                                        :label="$t('Chuyển đầy đủ nội dung từng hóa đơn')" />
                                                </v-sheet>
                                            </v-col>
                                            <v-col md="5">
                                                <v-sheet class="d-flex align-center pr-5">
                                                    <BaseCheckbox v-model="modelMaster.CBTHOP" true-value="1"
                                                        false-value="0"
                                        ...
                                        <v-row dense>
                                            ...
                                            <v-col md="6">
                                                <v-sheet class="d-flex align-center">
                                                    <BaseCheckbox v-model="modelMaster.HDGTGT" true-value="1"
                                                        false-value="0" :label="$t('Hóa đơn giá trị gia tăng')" />
                                                </v-sheet>
                                            </v-col>
                                            <v-col md="5">
                                                <v-sheet class="d-flex align-center">
                                                    <BaseCheckbox v-model="modelMaster.HDBHANG" true-value="1"
                                                        false-value="0" :label="$t('Hóa đơn bán hàng')" />
                                                </v-sheet>
                                            </v-col>
                                            ...
                                            <v-col md="6">
                                                <v-sheet class="d-flex align-center">
                                                    <BaseCheckbox v-model="modelMaster.HDBTSCONG" true-value="1"
                                                        false-value="0" :label="$t('Hóa đơn bán tài sản công')" />
                                                </v-sheet>
                                            </v-col>
                                            <v-col md="5">
                                                <v-sheet class="d-flex align-center">
                                                    <BaseCheckbox v-model="modelMaster.HDBHDTQGIA" true-value="1"
                                                        false-value="0" :label="$t('Hóa đơn bán hàng dự trữ quốc gia')" />
                                                </v-sheet>
                                            </v-col>
                                            ...
                                            <v-col md="6">
                                                <v-sheet class="d-flex align-center">
                                                    <BaseCheckbox v-model="modelMaster.HDKHAC" true-value="1"
                                                        false-value="0" :label="$t('Hóa đơn khác')" />
                                                </v-sheet>
                                            </v-col>
                                            <v-col md="5">
                                                <v-sheet class="d-flex align-center">
                                                    <BaseCheckbox v-model="modelMaster.CTU" true-value="1" false-value="0"
                                                        :label="$t('Chứng từ điện tử được sử dụng và quản lý như hóa đơn')" />
                                                </v-sheet>
                                            </v-col>
                                        </v-row>
    ...
    methods: {
            ...
            switch (pos) {
                ...
                case "saveMaster":
                    if (this.modelMaster.MCQTQLY == "00") {
                        ...
                        break;
                    } else if (this.modelMaster.DECLARE_CD == "00") {
                        ...
                        break;
                    } else if (this.modelMaster.HDGTGT == "0"
        ...
        async initHeaderList() {
            ...
            this.headerList.grdDetail =
                ...
                {
                    dataField: "TEI_WT_DECL_M_PK",
                    caption: this.$t("tei_wt_decl_m_pk"),
                    hidden: true,
                },
                {
                    dataField: "TTCHUC",
        ...
        async onSuccessGetDetailDeclaration(data) {
            ...
            this.$refs.grdDetail.addRowStruct({
                ...
                PK: "",
                TEI_WT_DECL_M_PK: this.modelMaster.PK,
                TTCHUC: this.getPara("CN", obj_token.issue_by),
                SST: obj_token.dn_stt,
        ...
        async initDataList() {
            const companyInfo = await this._callProcedure("EI_SEL_6095440_CompanyInfo", [this.user.PK]);
        ...
        async initModel() {
            ...
            this.modelMaster.DECLARE_CD = "1"; //Declare_CODE//
            this.modelMaster.TEN = "Tờ khai đăng ký/thay đổi thông tin sử dụng hóa đơn điện tử";
