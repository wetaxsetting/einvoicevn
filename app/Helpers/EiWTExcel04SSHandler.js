...
const EiExcelConverter = use("App/Helpers/EiWTExcel04SSConverter");
class EiExcelHandler {
  ...
  async getEinvoice(pk, p_language, p_crt_by, _db2 = "N") {
    try {
      ...
      const einvoiceMasterData = await DBService.callProcCursor("AC_SEL_EINVOICE_M_WT_04SS", [pk], p_language, p_crt_by, _db2);
      ...
      const einvoiceDetailData = await DBService.callProcCursor("AC_SEL_EINVOICE_D_WT_04SS", [pk], p_language, p_crt_by, _db2);
      ...
      reportPath = "report/60/95/ex_04ss/HD_WT_04SS_4.xlsx";
      reportSheet = "Invoice";
