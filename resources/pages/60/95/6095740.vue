<template>
  <v-container fluid v-resize="onResize">
    ...
    <button type="button" v-show="false" id="6095740-btnPrview" @click="previewCellFile"></button>
    <button type="button" v-show="false" id="6095740-btnPrview1" @click="previewCellFile1"></button>
    <button type="button" v-show="false" id="6095740-btnPrview2" @click="previewCellFile2"></button>
    <button type="button" v-show="false" id="6095740-btnPrview3" @click="previewCellFile3"></button>

    <input type="textbox" id="6095740-tempPK" v-show="false" />
    <input type="textbox" id="6095740-tempPK1" v-show="false" />
    <input type="textbox" id="6095740-tempPK2" v-show="false" />
    <input type="textbox" id="6095740-tempPK3" v-show="false" />
  </v-container>
</template>
...
export default {
  ...
  methods: {
    previewCellFile() {
      // console.log("previewCellFile-6095740!");
      this.currentRow = document.getElementById('6095740-tempPK').value;
    ...
    previewCellFile1() {
      // console.log("previewCellFile1-6095740!");
      this.currentRow = document.getElementById('6095740-tempPK1').value;
    ...
    previewCellFile2() {
      // console.log("previewCellFile2-6095740!");
      this.currentRow = document.getElementById('6095740-tempPK2').value;
    ...
    previewCellFile3() {
      // console.log("previewCellFile3-6095740!");
      this.currentRow = document.getElementById('6095740-tempPK3').value;
      // console.log("this.currentRow  previewCellFile2", this.currentRow);
      const ds = this.$refs.grdCompany.getDataSource();
      if (ds.length) {
        const found = ds.find((item) => item.PK == this.currentRow);
    ...
    myCellHTML(row, column, value, cellhtml) {
      ...
      const updateTempPK = `document.getElementById('6095740-tempPK').value = ${rowData.PK}; document.getElementById('6095740-tempPK1').value = ''; document.getElementById('6095740-tempPK2').value = ''; document.getElementById('6095740-tempPK3').value = ''`;
      const updateTempPK1 = `document.getElementById('6095740-tempPK').value = ''; document.getElementById('6095740-tempPK1').value = ${rowData.PK}; document.getElementById('6095740-tempPK2').value = ''; document.getElementById('6095740-tempPK3').value = ''`;
      const updateTempPK2 = `document.getElementById('6095740-tempPK').value = ''; document.getElementById('6095740-tempPK1').value = ''; document.getElementById('6095740-tempPK2').value = ${rowData.PK}; document.getElementById('6095740-tempPK3').value = ''`;
      const updateTempPK3 = `document.getElementById('6095740-tempPK').value = ''; document.getElementById('6095740-tempPK1').value = ''; document.getElementById('6095740-tempPK2').value = ''; document.getElementById('6095740-tempPK3').value = ${rowData.PK}`;
      let previewFile = `document.getElementById('6095740-btnPrview').click()`;
      let previewFile1 = `document.getElementById('6095740-btnPrview1').click()`;
      let previewFile2 = `document.getElementById('6095740-btnPrview2').click()`;
      let previewFile3 = `document.getElementById('6095740-btnPrview3').click()`;
