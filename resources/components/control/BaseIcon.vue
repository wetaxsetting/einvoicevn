            ...
            _processType() {
                ...
                switch (this.icon_type.toLowerCase()) {
                    ...
                    case "left_right":
                        ...
                        break;
                    case "detail":
                        icon_str = "mdi-table-of-contents";
                        break;
                    case "prev":
                    ...
                    case "cogs":
                        ...
                        break;
                    case "capture":
                        icon_str = "mdi-camera-plus";
                        break;
                    case "bc_scan":
                        icon_str = "mdi-barcode-scan";
                        break;
                    case "filesign":
                        icon_str = "mdi-file-sign";
                        // color_str = "error";
                        break;
                    case "pensign":
                        icon_str = "mdi-draw-pen";
                        color_str = "blue";
                        break;
                    case "sign":
                        icon_str = "mdi-signature-freehand";
                        break;
                    case "flow": 
                        icon_str = "mdi-alpha-f-circle-outline";
                        image_str = "flow.png";
                        break;
                    case "sync_cloud": 
                        icon_str = "mdi-cloud-sync-outline";
                        break;
                    case "upload_mutiple": 
                        icon_str = "mdi-download-multiple";
                        break;
                    default: {
