...
<v-container fluid v-resize="onResize">
    <v-row no-gutters>
        <v-col :cols="12 - RightCols">
            <GwGridLayout dense flat containerClass="py-0" @callBackHeight="parentLayoutHeight = $event">
                <!-- <BaseTabs @changed="tabChanged">
      <BaseTab :name="$t('leak')" tabname="leak" :eager="true"> -->
                <GwGridLayout child dense flat align="start" colsPerRow="1" containerClass="py-0 px-1" percentHeight="95" @callBackHeight="childrenLayoutHeight = $event">
      ...
      <BaseTab :name="$t('leak')" tabname="leak" :eager="true"> -->
                <GwGridLayout child dense flat align="start" colsPerRow="1" containerClass="py-0 px-1" percentHeight="95" @callBackHeight="childrenLayoutHeight = $event">
                    ...
                    <BaseGridView colspan="12" ref="gridview" :autoresize="false" :header="grd_header_d" :setting="true" :multiselect="true" :headertype="1" :height="gridHeight" sel_procedure="EI_SEL_6090300_SEL_TEI_EINVOICED_LOUD" :filter_paras="[this.item_pk]" :menu_cd="'6095300'" :id="'gridview'" allow-cookie />
                </GwGridLayout>
            </GwGridLayout>
        </v-col>
    </v-row>
