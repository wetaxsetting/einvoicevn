      ...
      <v-col cols="12">
        ...
        <v-row align="center" justify="center">
          ...
          <DataGridView column-resizing-mode="widget" 
              ...
              sel_procedure="AC_SEL_6060052_TAC_CRGOODSRTND_NOCACHE"
              upd_procedure="ac_upd_6060052_TAC_CRGOODSRTND" 
   ...
   async onSaveMaster() {
    ...
    itemInfoHeader_N() {
      ...
      this.headerGrid = [				
        ...
        {
          dataField:"TAC_CRGOODSRTN_PK", width:"0",
          allowEditing:false,
