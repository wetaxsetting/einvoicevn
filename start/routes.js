...
Route.get(
  "/:controller/:action",
  ({ auth, view, request, response, params }) => {
    const module = params.module;
    const controller = params.controller;
    const action = params.action;
    const controllerPath = `App/Controllers/Http/report/${controller.substr(
      3,
      2
    )}/${controller.substr(5, 2)}/`;
    const url = `${controllerPath}/${controller}.${action}`;
    const controllerInstance = ioc.makeFunc(url);
    return controllerInstance.method.apply(controllerInstance.instance, [
...
Route.group(() => {
  ...
  Route.post(
    "uploadfile2folder",
    "DsoController.UploadFileToFolderReturnURLToken"
  );
...
Route.group(() => {
  Route.post(
    "declare2xml",
    "EInvoiceController.convertDeclareUsingInvoiceToXML"
  );
  Route.post("invoice2xml", "EInvoiceController.convertInvoiceToXML");
  Route.post(
    "invoice2xmlfromclient",
    "EInvoiceController.convertInvoiceToXMLClient"
  );
  Route.post(
    "invalidinvoice2xml",
    "EInvoiceController.convertInvaliInvoiceToXML"
  );
  ...
  Route.post(
    "sendinvoicefromclient",
    "EInvoiceController.sendInvoiceToTaxOfficeFromClient"
  );
  Route.post(
    "checkinvoicestatus",
    "EInvoiceController.checkInvoiceStatusFromTaxOffice"
  );
  Route.post(
    "checkinvoicestatusfromclient",
    "EInvoiceController.checkInvoiceStatusFromClient"
  );
  Route.post(
    "senddeclaration",
    "EInvoiceController.sendDeclarationToTaxOffice"
  );
  Route.post(
    "senddeclarationfromclient",
    "EInvoiceController.sendDeclarationToTaxOfficeFromClient"
  );
  Route.post("checkingdeclaration", "EInvoiceController.checkingDeclarations");
  Route.post(
    "checkingdeclarationfromclient",
    "EInvoiceController.checkingDeclarationsFromClient"
  );
  Route.post(
    "sendinformadjustinvoice",
    "EInvoiceController.sendInformAdjustToTaxOffice"
  );
  Route.post(
    "sendinformadjustinvoicefromclient",
    "EInvoiceController.sendInformAdjustToTaxOfficeFromClient"
  );
  Route.post(
    "checkinformadjustinvoice",
    "EInvoiceController.checkInformAdjustToTaxOffice"
  );
  Route.post(
    "checkinformadjustinvoicefromclient",
    "EInvoiceController.checkInformAdjustToTaxOfficeFromClient"
  );
  Route.post("hsm-sign", "EInvoiceController.HsmSign");
  Route.post(
    "checkingstatuseinvoice",
    "EInvoiceController.checkingStatusEInvoice"
  );
  Route.get("downloadxml", "EInvoiceController.DownloadXML");
  Route.get("downloadpdf", "EInvoiceController.DownloadPDF");
  Route.post(
    "updatetemplate",
    "EInvoiceController.updateViewTemplateFromClient"
  ); //VNG_304

  // WeTax
  Route.post("json-to-excel", "EInvoiceController.renderJsonToExcelFile");
  Route.post(
    "generate-declare-xml",
    "EInvoiceController.weTaxConvertDeclareUsingInvoiceToXML"
  );
  Route.post(
    "send-declare",
    "EInvoiceController.weTaxSendDeclarationToTaxOffice"
  );
  Route.post(
    "check-status-declare",
    "EInvoiceController.weTaxCheckingDeclarations"
  );
  Route.post(
    "generate-notice-cancel-adjust-replace-xml",
    "EInvoiceController.weTaxConvertInvalidInvoiceToXML"
  );
  //Route.post("send-notice-cancel-adjust-replace", "EInvoiceController.weTaxSendInformAdjustToTaxOffice")
  Route.post(
    "send-notice-cancel-adjust-replace",
    "EInvoiceController.weTaxSendInformAdjustToTaxOffice2"
  );
  //Route.post("send-notice-cancel-adjust-replace-2", "EInvoiceController.weTaxSendInformAdjustToTaxOffice2")
  Route.post(
    "check-notification-status",
    "EInvoiceController.weTaxCheckInformAdjustToTaxOfficeTest"
  );
  ...
  Route.post(
    "send-order-info-update",
    "EInvoiceController.weTaxUpdateSendOrderInfo"
  );
  Route.post(
    "get-sendmail-invoice-status",
    "EInvoiceController.weTaxCheckStausSendMail"
  );
  Route.post(
    "generate-pos-invoice-xml",
    "EInvoiceController.weTaxConvertPosInvoiceToXML"
  );
  Route.post(
    "send-pos-invoice",
    "EInvoiceController.weTaxSendPosInvoiceToTaxOffice"
  );
  Route.post("send-invoice", "EInvoiceController.weTaxSendInvoiceToTaxOffice");
  Route.post(
    "check-status-invoice",
    "EInvoiceController.weTaxCheckInvoiceStatusFromTaxOffice"
  );
  Route.post(
    "generate-invoice-xml",
    "EInvoiceController.weTaxConvertInvoiceToXML"
  );
  ...
  Route.post(
    "re-send-normal-invoice",
    "EInvoiceController.weTaxReSendNormalInvoice"
  );
  Route.post(
    "send-company-template",
    "EInvoiceController.weTaxSendCompanyTemplate"
  );
  Route.post(
    "generate-records-xml",
    "EInvoiceController.weTaxGenerateRecordsXml"
  );
  ...
  Route.post(
    "general-pos-invoice-xml-view",
    "EInvoiceController.generalXmlPosInvoiceView"
  );
  Route.post(
    "general-pos-invoice-xml",
    "EInvoiceController.generalXmlPosInvoice"
  );
  ...
  Route.post(
    "check-status-invoice-at",
    "EInvoiceController.checkInvoiceStatus"
  );
  Route.post("general-url-pdf", "EInvoiceController.viewPDFEPortal");
  Route.post(
    "general-url-pdf-template",
    "EInvoiceController.viewPDFTemplateEPortal"
  );
  Route.post(
    "general-url-pdf-einvoice-bb",
    "EInvoiceController.viewPDFEinvoiceBBEPortal"
  );
  Route.post(
    "general-url-pdf-einvoice-bb-r",
    "EInvoiceController.viewPDFEinvoiceBBReplaceEPortal"
  );
  Route.post(
    "send-mail-invalid-invoice",
    "EInvoiceController.sendMailInvalidInvoice"
  );
  Route.post("send-mail-at", "EInvoiceController.sendMailAt");
  Route.post(
    "general-pdf-template-04SS",
    "EInvoiceController.viewPDFTemplate_04SS"
  ); ////VNG-304
  Route.post(
    "general-pdf-template-WT-04SS",
    "EInvoiceController.viewPDFTemplate_WT_04SS"
  ); ////VNG-304-6095460
  Route.post(
    "general-url-pdf-einvoice-WT-04SS-bb",
    "EInvoiceController.viewPDFTemplate_WT_04SS_BB"
  ); ////VNG-304-6095460
  Route.post(
    "general-url-pdf-einvoice-WT-04SS-bb-r",
    "EInvoiceController.viewPDFTemplate_WT_04SS_BBR"
  ); ////VNG-304-6095460
  Route.post("general-pdf-template-WT", "EInvoiceController.viewPDF_InvoiceWT"); ////VNG-304
  Route.post(
    "general-pdf-template-send-bill",
    "EInvoiceController.viewPDF_SaleBillWT"
  ); ////VNG-304
  Route.post(
    "send-data-pos-invoice-erp",
    "EInvoiceController.sendPosInvoiceErp"
  );
...
Route.group(() => {
  ...
  Route.post(
    "send-pos-invoice",
    "EInvoiceController.weTaxSendPosInvoiceToTaxOffice2"
  );
  Route.post(
    "generate-notification-records-xml",
    "EInvoiceController.sendInformAdjustToTaxOffice2"
  );
  Route.post(
    "send-company-template",
    "EInvoiceController.weTaxSendCompanyTemplate2"
  );

  //e-invoice
  Route.post(
    "invalidinvoice2xml",
    "EInvoiceController.convertInvaliInvoiceToXML2"
  );
  Route.post(
    "sendinformadjustinvoice",
    "EInvoiceController.sendInformAdjustToTaxOffice2"
...
Route.group(() => {
  ...
  Route.post(
    "general-convert-einvoice",
    "EInvoiceController.generalConvertEinvoice"
  );
  Route.post(
    "lookup-minutes",
    "EInvoiceController.getDataEinvoiceFormLookupMinutesCode"
  );
  Route.post(
    "lookup-minutes-update",
    "EInvoiceController.getUpdateXmlBuyerSign"
  );
}).prefix("api/einvoice");
