<template>
  <div>
    <v-dialog id="get-apother-dialog" max-width="1200" v-model="dialogIsShow">
        <v-card>
          <v-card-title class="headline primary-gradient white--text py-2">{{ $t('get a/p other','common') }}</v-card-title>
              ...
              <v-row dense align="start" justify="center">
                <v-col cols="12"  class="pt-0">
                  <DxDataGrid column-resizing-mode="widget" ref="grdMasterItem" 
                    ...
                    <DxColumn data-field="VOUCHER_NO"         :caption="$t('voucher_no')"        dataType="string" :allow-editing="false"  />
                    ...
                    <DxColumn data-field="VENDOR_NAME"  :caption="$t('vendor_name')"   dataType="string" :allow-editing="false" />
              ...
              <v-row dense align="start" justify="center">
                <v-col cols="12"  class="pt-0">
                  <DxDataGrid 
                    ...
                    <DxColumn data-field="VOUCHER_NO"           :caption="$t('voucher_no')"              dataType="string" :allow-editing="false" width="80" />             
                    ...
                    <DxColumn data-field="TAC_ABACCTCODE_D_PK"  :caption="$t('tac_abacctcode_pk')"   dataType="string" :allow-editing="false" css-class="cell-align-left" width="0"/>
                    <DxColumn data-field="AC_CD"                :caption="$t('ac_cd')"               dataType="number" :allow-editing="false" css-class="cell-align-left" width="80"/>
                    ...
                    <DxColumn data-field="TIN_WAREHOUSE_PK"     :caption="$t('tin_warehouse_pk')"    dataType="string" :allow-editing="false"  css-class="cell-align-left" width="0" />
                    <DxColumn data-field="WH_NAME"              :caption="$t('wh_name')"             dataType="string" :allow-editing="false"  css-class="cell-align-left" width="100"/>
                    <DxColumn data-field="TAC_ABACCTCODE_PK"    :caption="$t('tac_abacctcode_m_pk')"   dataType="string" :allow-editing="false"  css-class="cell-align-left" width="0" />
                    ...
                    <DxColumn data-field="PL_CD"                :caption="$t('pl_cd')"         dataType="string" :allow-editing="false"  css-class="cell-align-left" />
                    <DxColumn data-field="PL_NM"                 :caption="$t('plnm')"         dataType="string" :allow-editing="false"  css-class="cell-align-left" />
...
export default {
  ...
  methods: {
    ...
    async searchMaster(_param) {
      const dso = {
        type: 'grid',
        selpro: 'AC_SEL_6050020_CRDA_OTHER_M',
        para: _param
      }
    ...
    async searchDetails(_param) {  
			const dso = {
        type: 'list',
        selpro: 'AC_SEL_6050020_CRDA_OTHER_D',
        para: _param
      }
