  ...
  methods: {
    ...
    openItemAccDialog(row){
      ...
      /*  this.selectedAccount = { ...row };
        ...
        this.dialogTitle = this.$t("bank_deposit", "common");
        this.codeLabel = this.$t("bank_id", "common");
        this.nameLabel = this.$t("bank_name", "common");
    ...
    cellControlDblClick(row) {
      ...
      else if (this.selectedRow.data.TAC_ABACCTITEM_PK == "-3") 
      {
          
      } else if (this.selectedRow.data.ITEM_ALIAS == "DEPOSIT ACCOUNT NO") {
        this.dynamicHeader = this.BuildDynamicHeader("TAC_ABDEPOMT");
        this.dialogTitle = this.$t("bank_deposit", "common");
        this.codeLabel = this.$t("bank_id", "common");
        this.nameLabel = this.$t("bank_name", "common");
        ...
        this.dialogTitle = this.$t("bank_beneficiary");
        this.codeLabel = this.$t("account_no", "common");
        this.nameLabel = this.$t("bank_name", "common");
        ...
        this.dialogTitle = this.$t("biz_place", "common");
        this.codeLabel = this.$t("location_id", "common");
        this.nameLabel = this.$t("location_name", "common");
