<template>
  <v-dialog id="plan-dialog" max-width="1000" v-model="dialogIsShow">
    <v-card>
              ...
              <v-col cols="12" class="py-0">
                <v-card outlined tile v-resize="onResize">
                  <DataGridView 
                    ...
                    sel_procedure="AC_SEL_6021030_POPUP_2" 
                    upd_procedure="" 
                    :update_paras="[ ]" 
                    :filter_paras="[
                      this.selectedCompany,
                      this.tac_abtrtype_pk_plan,
                      this.from_date,
                      this.to_date,
                      this.lstSlipStatus,
                      this.txt_seq,
...
export default {
  ...
  props: {
    ...
    p_tac_abtrtype_pk_plan:{ type: Number, default: 0 },
  },
  ...
  watch: {
    ...
    dialogIsShow(val) {
       if(val === true) {
          ...
          this.tac_abtrtype_pk_plan = this.p_tac_abtrtype_pk_plan;
      }
    }
  },
  computed: {
  ...
  methods: {
    async getListCodes() {
        ...
        const dso_Voucher_type_list = { 
                  type: 'list', selpro: 'SYS_SEL_BUDGET_LIST_CODE', 
                  para: ["PL",this.user.TCO_COMPANY_PK, "ACBD0030"] }
    ...
    OnSum(){
      ...
      console.log(this.$refs.grdData.getDataSource());
      setTimeout(() => {
    ...
    onSelectMultiple() {
      ...
      this.returnPlanDialog(rtn_data);
      this.callBackData(rtn_data);  
    },

    returnPlanDialog(datas) {
      this.$emit("returnPlanDialog", datas);
      this.dialogIsShow = false;
    },
  },
};
