    ...
    try {
      const errorList = {
        ...
        detail_invoice: {
          ...
          vat_rate: /^((0|5|8|10)(\.0+)?%)$|^KCT$|^KKKNT$|^CTTC$|^KHAC(:\d+(\.\d+)?%)?$/i, ///^(0%|5%|8%|10%)$/, //  /^-?\d+(\.\d{1,4})?[%]/,
          amt_vat: /^-?[0-9]{0,21}(?:\.[0-9]{1,6})?$/, //21, 6
        },

        total_vat_list: {
          sub_vat_rate: /^((0|5|8|10)(\.0+)?%)$|^KCT$|^KKKNT$|^CTTC$|^KHAC(:\d+(\.\d+)?%)?$/i, ///^(0%|5%|8%|10%)$/, //  /^-?\d+(\.\d{1,4})?[%]/, //11,
  ...
  weTaxValidateNormalInvoiceToXML(invoices) {
    ...
    try {
      const errorList = {
        ...
        total_vat_list: {
          sub_vat_rate:  /^((0|5|8|10)(\.0+)?%)$|^KCT$|^KKKNT$|^CTTC$|^KHAC(:\d+(\.\d+)?%)?$/i, ///^(0%|5%|8%|10%|KCT|KKKNT)$/, //sub_vat_rate: /^(0%|5%|8%|10%)$/, //  /^-?\d+(\.\d{1,4})?[%]/, //11,
          sub_amt: /^-?[0-9]{0,21}(?:\.[0-9]{1,6})?$/,
          sub_amt_vat: /^-?[0-9]{0,21}(?:\.[0-9]{1,6})?$/,
        },
