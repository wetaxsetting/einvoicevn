...
let EiExcelHandler = {
  getEinvoice: async (that, einvoicePk) => {
    ...
    const einvoiceMasterData = await that._callProcedure(
      "stacfdstac71_r_02_view_einv_v2_nodejs",
      [einvoicePk, '',]
    );
    const einvoiceDetailData = await that._callProcedure(
      "stacfdstac71_r_03_view_einv_nodejs",
      [einvoicePk, '',]
    );
    ...
    switch (companyName) {
      ...
      case "Genuwin":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          ...
          default:
            ...
            bgPath = require("assets/images/einvoices_logo/Genuwin/bg.png")
            logos = [
              { start: 1.2, width: 1.7 * dpi, height: 0.83 * dpi, logoStartCount: 0.2, logoPath: require("assets/images/einvoices_logo/Genuwin/companylogo.png") },
      ...
      case "Sprint":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            logos = [
              { start: 1, width: 1.19 * dpi, height: 0.87 * dpi, logoStartCount: 0.2, logoPath: require("assets/images/einvoices_logo/Sprint/companylogo.png") },
      ...
      case "Hiknit":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            //bgPath = require("assets/images/einvoices_logo/Hiknit/bg.png")
            logos = [
              { start: 0.3, width: 2.57 * dpi, height: 1.26 * dpi, logoStartCount: 2.5, logoPath: require("assets/images/einvoices_logo/Hiknit/companylogo.png") },
      ...
      case "Bkvina":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            if (convertYn == "Y") {
              reportPath = 'report/60/95/einvoices_template/Bkvina/Bkvina_convert_1.xlsx'
              reportSheet = "HD GTGT"
              masterDataArray.push(
              ...
              reportPath = 'report/60/95/einvoices_template/Bkvina/Bkvina_1.xlsx'
              reportSheet = "HD GTGT"
            }


            bgPath = require("assets/images/einvoices_logo/Bkvina/bg.png")
            logos = [
              { start: 1, width: 1.52 * dpi, height: 1.1 * dpi, logoStartCount: 2.5, logoPath: require("assets/images/einvoices_logo/Bkvina/companylogo.png") },

            ]

            //mảng data của master
            masterDataArray.push(
              { Cell: `O11`, Info: [`TEMPLATECODE`, `INVOICESERIALNO`], Type: 1 },
      ...
      case "Kukil":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            bgPath = require("assets/images/einvoices_logo/Kukil/bg.png")
            logos = [
              { start: 1.1, width: 0.92 * dpi, height: 1.12 * dpi, logoStartCount: 0.2, logoPath: require("assets/images/einvoices_logo/Kukil/companylogo.png") },
      ...
      case "Otm":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "2":
            ...
            // bgPath = require("assets/images/einvoices_logo/Otm/bg.png")

            logos = [
              { start: 4, width: 0.45 * dpi, height: 0.5 * dpi, logoStartCount: 0.5, logoPath: require("assets/images/einvoices_logo/Otm/companylogo.png") },
      ...
      case "Samil":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            // bgPath = require("assets/images/einvoices_logo/Samil/bg.png")

            logos = [
              { start: 3.5, width: 2.63 * dpi, height: 0.33 * dpi, logoStartCount: 1.2, logoPath: require("assets/images/einvoices_logo/Samil/companylogo.png") },
      ...
      case "Cuckoo":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            bgPath = require("assets/images/einvoices_logo/Cuckoo/bg.png")

            logos = [
              { start: 1, width: 1.49 * dpi, height: 0.44 * dpi, logoStartCount: 4, logoPath: require("assets/images/einvoices_logo/Cuckoo/companylogo.png") },
      ...
      case "Jungwoo":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            //bgPath = require("assets/images/einvoices_logo/Jungwoo/bg.png")

            logos = [
              { start: 0.5, width: 1.45 * dpi, height: 0.74 * dpi, logoStartCount: 2, logoPath: require("assets/images/einvoices_logo/Jungwoo/companylogo.png") },
            ]
            msThueCutter(["G", "H", "I", "J", "K", "L", "M", "N", "O", "P", "Q", "R"], einvoiceMasterData[0].SELLER_TAXCODE.replace(/\s+/g, ''), 14)
            msThueCutter(["G", "H", "I", "J", "K", "L", "M", "N", "O", "P", "Q", "R"], einvoiceMasterData[0].BUYERTAXCODE.replace(/\s+/g, ''), 23)
      ...
      case "Kyungbang":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            bgPath = require("assets/images/einvoices_logo/Kyungbang/bg.png")

            logos = [
              { start: 2, width: 1.17 * dpi, height: 1.03 * dpi, logoStartCount: 0.5, logoPath: require("assets/images/einvoices_logo/Kyungbang/companylogo.png") },
            ]
      ...
      case "ParisVN":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            bgPath = require("assets/images/einvoices_logo/ParisVN/bg.png")

            logos = [
              { start: 22, width: 1.06 * dpi, height: 0.85 * dpi, logoStartCount: 1, logoPath: require("assets/images/einvoices_logo/ParisVN/companylogo.png") },
              { start: 1, width: 3.46 * dpi, height: 0.54 * dpi, logoStartCount: 1, logoPath: require("assets/images/einvoices_logo/ParisVN/companylogo2.png") },
              { start: 1, width: 1.09 * dpi, height: 0.97 * dpi, logoStartCount: 6.5, logoPath: qrPath }
            ]
            ...
            masterDataArray.push(
              ...
              { Cell: `Q5`, Info: [`SELLER_FAX`], Type: 1 },
              { Cell: `E6`, Info: [`SELLER_ACCOUNTNO`], Type: 1 },
              { Cell: `D6`, Info: [`BUYER_BANK_NAME`], Type: 1 },
      ...
      case "During":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            // let width=1.19
            // let height=1.32
            //logoPath = require("@/assets/images/einvoices_logo/During/companylogo.png")
            bgPath = require("@/assets/images/einvoices_logo/During/bg.png")
            logos = [
              { start: 2, width: 1.19 * dpi, height: 1.32 * dpi, logoStartCount: 1.5, logoPath: require("assets/images/einvoices_logo/During/companylogo.png") }
            ]
      ...
      case "Ajtotal":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            bgPath = require("@/assets/images/einvoices_logo/Ajtotal/bg.png")
            logos = [
              { start: 1, width: 1.62 * dpi, height: 0.64 * dpi, logoStartCount: 1, logoPath: require("@/assets/images/einvoices_logo/Ajtotal/companylogo.png") }
      ...
      case "Daewon":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            logos = [
              { start: 2, width: 0.88 * dpi, height: 0.65 * dpi, logoStartCount: 1, logoPath: require("@/assets/images/einvoices_logo/Daewon/companylogo.png") }
            ]
      ...
      case "Yupoong":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "2":
            ...
            logos = [
              { start: 1, width: 0.99 * dpi, height: 0.62 * dpi, logoStartCount: 1, logoPath: require("@/assets/images/einvoices_logo/Yupoong/companylogo.png") }
            ]
            bgPath = require("@/assets/images/einvoices_logo/Yupoong/bg.png")
          ...
          case '07KPTQ0/001':
            ...
            logos = [
              { start: 1, width: 0.93 * dpi, height: 0.66 * dpi, logoStartCount: 5, logoPath: require("@/assets/images/einvoices_logo/Yupoong/companylogo.png") }
            ]
            bgPath = require("@/assets/images/einvoices_logo/Yupoong/bg.png")
            ...
            masterDataArray.push(
              ...
              { Cell: `E13`, Info: [`SELLER_ACCOUNTNO`, `BUYER_BANK_NAME`], Type: 1 },
      ...
      case "Suheung":
        ...
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            logos = [
              { start: 1, width: 1.32 * dpi, height: 1.09 * dpi, logoStartCount: 1, logoPath: require("@/assets/images/einvoices_logo/Suheung/companylogo.png") }
            ]
            ...
            masterDataArray.push(
              ...
              { Cell: `E12`, Info: [`SELLER_ACCOUNTNO`, `BUYER_BANK_NAME`], Type: 1 },
      ...
      case "Kpx":
        ...
        logos = [
          { start: 1, width: 1.63 * dpi, height: 0.8 * dpi, logoStartCount: 1, logoPath: require("@/assets/images/einvoices_logo/Kpx/companylogo.png") }
        ]
        ...
        masterDataArray.push(
          ...
          { Cell: `I5`, Info: [`SELLER_ACCOUNTNO`, `BUYER_BANK_NAME`], Type: 1 },
          // { Cell: `E15`, Info: [`SELLER_ACCOUNTNO2`, `BANK_NM79`], Type: 1 },
      ...
      case "Daeyoung":
        switch (einvoiceMasterData[0].TEMPLATECODE) {
          case "1":
            ...
            logos = [
              { start: 1, width: 1.68 * dpi, height: 0.28 * dpi, logoStartCount: 1, logoPath: require("@/assets/images/einvoices_logo/Daeyoung/companylogo.png") }
            ]
