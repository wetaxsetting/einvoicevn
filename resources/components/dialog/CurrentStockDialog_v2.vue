        ...
        <v-container>
          <v-row dense align="start" justify="center">
            <v-col md="2" class="pt-0" align="right">
              <v-menu ref="menuDate" :close-on-content-click="true" :return-value.sync="gw_StockDate.value" :disabled="gw_StockDate.disabled" transition="scale-transition" offset-y max-width="290px" min-width="290px">
                <template v-slot:activator="{ on, attrs }">
                  <v-text-field v-model="gw_StockDate.value" :label="$t('stock_date')" readonly hide-details outlined dense v-bind="attrs" v-on="on"></v-text-field>
                </template>
            ...
            <v-col md="2" class="pt-0">
              <v-select v-model="gw_Wh.value" :label="$t('warehouse','common')" :items="dataList.lstWH" item-value="CODEKEY" item-text="CODEDESC" :disabled="gw_Wh.disabled" dense cache-items hide-details outlined />
            </v-col>
            <v-col md="2" class="pt-0">
              <v-select v-model="gw_ItemGrp_PK.value" :label="$t('item_group','common')" :items="dataList.lstItemGrp" item-value="CODEKEY" item-text="CODEDESC" dense cache-items hide-details outlined />
            </v-col>
            <v-col md="2" class="pt-0">
          ...
          <v-row dense align="start" justify="center">
            <v-col cols="12" class="pt-0">
              <DxDataGrid column-resizing-mode="widget" ref="grdStockSearch" :allow-column-resizing="true" :column-auto-width="$vuetify.breakpoint.smAndDown" :data-source="dataGrid1" :height="limitHeightGrd1" :no-data-text="$t('no_data', 'common')" :show-borders="true" :show-column-lines="true" :show-row-lines="true" :onRowDblClick="onRowDblClickGrd1">

                <DxColumn data-field="WH_NAME" :caption="$t('wh_name','common')" dataType="string" :allow-editing="false" width="120" css-class="cell-align-left" />
                <DxColumn data-field="TLG_IT_ITEM_PK" dataType="number" :allow-editing="false" :visible="false" />
                <DxColumn data-field="ITEM_CODE" :caption="$t('item_code','common')" dataType="string" :allow-editing="false" width="100" css-class="cell-align-left" />
                <DxColumn data-field="ITEM_NAME" :caption="$t('item_accnm','common')" dataType="string" :allow-editing="false" width="150" css-class="cell-align-left" />
                <DxColumn data-field="PO_NO" :caption="$t('po_no','common')" dataType="string" :allow-editing="false" width="120" css-class="cell-align-left" />
                <DxColumn data-field="LOT_NO" :caption="$t('lot_no','common')" dataType="string" :allow-editing="false" width="80" css-class="cell-align-left" />
                <DxColumn data-field="GRADE" :caption="$t('grade','common')" dataType="string" :allow-editing="false" width="60" css-class="cell-align-left" />
                <DxColumn data-field="STOCK_QTY" :caption="$t('qty','common')" dataType="number" format="###,###,###.##" :allow-editing="false" width="80" css-class="cell-align-right" />
                <DxColumn data-field="UOM" :caption="$t('uom','common')" dataType="string" :allow-editing="false" width="60" css-class="cell-align-left" />
                <DxColumn data-field="REF_QTY" :caption="$t('ref_qty','common')" dataType="number" format="###,###,###.##" :allow-editing="false" width="80" css-class="cell-align-right" />
                <DxColumn data-field="REF_UOM" :caption="$t('ref_uom','common')" dataType="string" :allow-editing="false" width="60" css-class="cell-align-left" />
                <DxColumn data-field="REF_QTY_2" :caption="$t('ref_qty_2','common')" dataType="number" format="###,###,###.##" :allow-editing="false" width="80" css-class="cell-align-right" />
                <DxColumn data-field="REF_UOM_2" :caption="$t('ref_uom_2','common')" dataType="string" :allow-editing="false" width="60" css-class="cell-align-left" />
                <DxColumn data-field="TLG_IN_WHLOC_PK" dataType="number" :allow-editing="false" :visible="false" />
                <DxColumn data-field="LOC_NAME" :caption="$t('location','common')" dataType="string" :allow-editing="false" width="150" css-class="cell-align-left" />
                <DxColumn data-field="EXPIRE_DATE_1" :caption="$t('expire_date_1')" dataType="date" :allow-editing="false" width="150" css-class="cell-align-left" />
          ...
          <v-row dense align="start" justify="center">
            <v-col cols="12" class="pt-0">
              <DxDataGrid column-resizing-mode="widget" ref="grdStockSelect" :allow-column-resizing="true" :column-auto-width="$vuetify.breakpoint.smAndDown" :data-source="dataGrid2" :height="limitHeightGrd2" :no-data-text="$t('no_data', 'common')" :show-borders="true" :show-column-lines="true" :show-row-lines="true" :onRowDblClick="onRowDblClickGrd2">
                ...
                <DxColumn data-field="GRADE" :caption="$t('grade','common')" dataType="string" :allow-editing="false" width="60" css-class="cell-align-left" />
                <DxColumn data-field="STOCK_QTY" :caption="$t('qty','common')" dataType="number" format="###,###,###.##" :allow-editing="false" width="80" css-class="cell-align-right" />
                <DxColumn data-field="UOM" :caption="$t('uom','common')" dataType="string" :allow-editing="false" width="60" css-class="cell-align-center" />
                <DxColumn data-field="REF_QTY" :caption="$t('ref_qty','common')" dataType="number" format="###,###,###.##" :allow-editing="false" width="80" css-class="cell-align-right" />
                <DxColumn data-field="REF_UOM" :caption="$t('ref_uom','common')" dataType="string" :allow-editing="false" width="60" css-class="cell-align-left" />
                <DxColumn data-field="REF_QTY_2" :caption="$t('ref_qty_2','common')" dataType="number" format="###,###,###.##" :allow-editing="false" width="80" css-class="cell-align-right" />
                <DxColumn data-field="REF_UOM_2" :caption="$t('ref_uom_2','common')" dataType="string" :allow-editing="false" width="60" css-class="cell-align-left" />
...
export default {
  ...
  methods: {
    ...
    async LG_SEL_CURRENT_STOCK_DIALOG(_param) {
      const dso = {
        type: 'grid',
        selpro: 'LG_SEL_CURRENT_STOCK_DIALOG_V2',
        para: _param
      }
    ...
    async LG_LST_CURRENT_STOCK_DIALOG(_param) {
      ...
      switch (_param[0]) {
        ...
        case 'ITEMGRP':
          ...
          this.dataList.lstItemGrp.unshift({
            CODEKEY: "",
            CODEDESC: "All"
          });
          if (this.dataList.lstItemGrp.length > 0) {
