...
export default {
  ...
  methods: {
    async onSearch() {
      ...
      var _para = [ this.txtAccountCode,this.txtAccountName,this.txtAccountUpperName,'Y','Y',p_compk,this.txtGroupName];
      if(this.group_code != 0)
      {
          _para = [ this.txtAccountCode,this.txtAccountName,this.txtAccountUpperName,'Y','Y',p_compk,this.txtGroupName];
      }
