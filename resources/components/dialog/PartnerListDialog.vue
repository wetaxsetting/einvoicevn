                                ...
                                <v-container fluid class="pb-0">
                                    <v-row dense align="center" justify="space-between">
                                        <v-col lg="2" sm="2" cols="2" class="pb-2">
                                            <v-select dense cache-items hide-details item-value="PK" item-text="TEXT" :label="$t('company', 'common')" :items="companyList" v-model="selectedCompany" @change="onSearch"></v-select>
                                        </v-col>
                                        <v-col lg="2" sm="2" cols="2" class="pb-2">
                                            <v-select dense clearable hide-details item-value="PK" item-text="TEXT" :label="$t('biz_place')" :items="bizPlaceList" v-model="lstBizPlace"></v-select>
                                        </v-col>
                                        <v-col lg="2" sm="2" cols="2" class="pb-2">
...
export default {
    ...
    created() {
        console.log("tco_busplace_pk " + this.tco_busplace_pk);
        ...
        this.lstBizPlace = this.tco_busplace_pk;
        this.onSearch();
    },
    ...
    methods: {
        ...
        async onSearch() {
            const dso = {
                type: "grid",
                selpro: "SYS_SEL_BUSPARTNER_LIST_DIALOG",
                para: [
