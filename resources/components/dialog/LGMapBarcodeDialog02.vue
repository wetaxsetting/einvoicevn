                  ...
                  <v-row align="center" justify="space-between" no-gutters >
                    <v-col md="12" class="pa-1">
                      <DataGridView
                            ...
                            ref="grdDetail01"                   
                            sel_procedure="LG_SEL_LGMAPBARCODEDIALOG02_1_NOCACHE"
                            upd_procedure=""
                          ...
                          :header="[     
                            ...
                            {dataField:'LOC_NAME',caption:this.$t('loc_name'),allowEditing:false, width: 200, visible: false },
                  ...
                  <v-row align="center" justify="space-between" no-gutters >
                    <v-col md="12" class="pa-1">
                      <DataGridView
                            column-resizing-mode="widget"
                            ref="grdDetail02"                   
                            sel_procedure="LG_SEL_LGMAPBARCODEDIALOG02_2_NOCACHE"
                            upd_procedure="LG_UPD_LGMAPBARCODEDIALOG02_2_NOCACHE"
                            select_mode="Multiple"
                            :auto_load="false"
                            :max_height="heightGridDetail"                                                            
