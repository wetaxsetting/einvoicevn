            ...
            <v-row dense align="start" justify="center">
              <v-col cols="12"  class="pt-0">
                <DxDataGrid column-resizing-mode="widget" ref="grdFreeItemSearch" 
                  ...
                  <DxColumn data-field="RATE_01" :caption="$t('ref_rate')" 
                              dataType="number" format="###,###,###.##" :allow-editing="false" width="80" css-class="cell-align-right" />
                  <DxColumn data-field="UNIT_PRICE_01" :caption="$t('ref_unit_price')" 
                              dataType="number" format="###,###,###.##" :allow-editing="false" :visible="false" width="80" css-class="cell-align-right" />
                  <DxColumn data-field="UOM_02" :caption="$t('ref_uom_2')" 
                              dataType="string" :allow-editing="false" :visible="false" width="60" css-class="cell-align-left"/>                              
                  <DxColumn data-field="RATE_02" :caption="$t('ref_rate_2')" 
                              dataType="number" :allow-editing="false"  css-class="cell-align-right" />
                  <DxColumn data-field="UNIT_PRICE_02" :caption="$t('ref_unit_price_2')" 
                              dataType="number" format="###,###,###.##" :allow-editing="false" :visible="false" width="80" css-class="cell-align-right" />   
                  <DxColumn data-field="UOM_03" :caption="$t('ref_uom_3')" 
                              dataType="string" :allow-editing="false" :visible="false" width="60" css-class="cell-align-left"/>                              
                  <DxColumn data-field="RATE_03" :caption="$t('ref_rate_3')" 
                              dataType="number" :allow-editing="false" css-class="cell-align-right" />
                  <DxColumn data-field="UNIT_PRICE_03" :caption="$t('ref_unit_price_3')" 
                              dataType="number" format="###,###,###.##" :allow-editing="false" :visible="false" width="80" css-class="cell-align-right" />             
            ...
            <v-row dense align="start" justify="center">
              <v-col cols="12"  class="pt-0">
                <DxDataGrid column-resizing-mode="widget" ref="grdFreeItemSelect" 
                  ...
                  <DxColumn data-field="F_SEQ" :caption="$t('f_seq')" 
                              dataType="number" format="###,###,###.##" :allow-editing="false" width="80" css-class="cell-align-left" />
                  <DxColumn data-field="UOM_01" :caption="$t('ref_uom')" 
                              dataType="string" :allow-editing="false" :visible="false" width="60"  css-class="cell-align-left" />
                  <DxColumn data-field="RATE_01" :caption="$t('ref_rate')" 
                              dataType="number" format="###,###,###.##" :allow-editing="false" width="80" css-class="cell-align-right" />
                  <DxColumn data-field="UNIT_PRICE_01" :caption="$t('ref_unit_price')" 
...
export default {
  ...
  methods: {
    ...
    async LG_SEL_FREEITEM_DIALOG_1(_param) {
      const dso = {
        type: 'grid',
        selpro: 'LG_SEL_FREEITEM_DIALOG_V2_1',
        para: _param
      }
