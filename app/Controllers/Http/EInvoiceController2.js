      ...
      if (process_type == 'E') {
        ...
        for (let i = 0; i < invoices.length; i++) {
          ...
          if(invoices[i].version == "2.1.0") {
            ...
            objInvoice.HDon.DLHDon.TTChung.HDCTTChinh = invoices[i].lease_invoice_type || '0'; //webcashgenuwin.com taxcode
  ...
  convertHtmlCode(sText) {
    if (sText != null || sText == '') {
      return this.replaceAllExt(
        ...
        '>',
        '&gt;',
      ); //vng-199 tạm thời đóng đoạn này vì sửa lý ở C# khi ký
      /* this.replaceAllExt(
