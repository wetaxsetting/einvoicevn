...
export default {
  ...
  methods: {
    ...
    onAddAcntMaster() {
        ...
        this.procedure      = "AC_SEL_6060020_CRCA_CTRLITEM_P";
    ...
    cellControlDblClick(row) {
     ...
     if(this.selectedRow.data.ITEM_NM=== 'PAYMENT METHOD')
     {
        ...
        this.procedure      = "AC_SEL_6060020_POPUP_ITEM";
        this.moreParas      = ['PAYMENT METHOD',''];
        this.autoSearch     = true;
        this.multiSelectMode = false;
        this.$refs.refDynamicDialog.dialogIsShow = true;
     }else
     if(this.selectedRow.data.ITEM_NM=== 'ITEM')
     {
        this.dynamicHeader  = this.BuildDynamicHeader("PAYMENT METHOD");
        this.dialogTitle    = this.$t("payment_method");
        this.codeLabel      = this.$t("payment_id");
    ...
    async getAcntIDList(paras) {
      const dso = {
        type: "grid",
        selpro: "AC_SEL_6060020_CRCA_CTRLITEM",
    ...
    async saveMaster() {
      ...
      if(dataIsModified) {
        const dso = {
          type: 'grid',
          selpro: 'AC_SEL_6060020_CRCA_CTRLITEM',
          updpro: 'AC_UPD_6060020_CRCA_CTRLITEM',
