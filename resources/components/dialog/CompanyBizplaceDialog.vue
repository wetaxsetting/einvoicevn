...
export default {
  ...
  computed: {
    ...
    companyTableHeaders() {
      return [
        ...
        { text: this.$t('company_id'), value: 'PARTNER_ID', class: ' secondary white--text blue darken-2', divider: true }, 
        { text: this.$t('company_name'), value: 'PARTNER_NAME', class: ' secondary white--text blue darken-2', divider: true },
  ...
  methods: {
    ...
    getCompanyList(paramsData) {
      ...
      this.$axios.$post("dso/callproc", { proc: "ac_sel_6010020_companys_v2", para: [p_companyVal] })
        .then((res) => {
