        ...
        <v-row align="center" justify="center">
          ...
          <v-col lg="4" cols="12">
           ...
           <v-col lg="2" cols="12" class="text-right">
            ...
            <v-btn icon tile :color="currentTheme"  :disabled="!btnSave_Allocate"  @click="onSaveTaxCal" >
...
export default {
  ...
  methods: {
    ...
    async search(paramsData) {
      ...
      const dso = {
        type: "grid",
        selpro: "AC_SEL_6060018_CRCAD_COST",
  ...
  onSearchDetails(paras) {
    ...
    async save(searchParams) {
      ...
      const dso = {
        type: "grid",
        selpro: "AC_SEL_6060018_CRCAD_COST",
        updpro: "AC_UPD_6060018_CRCAD_COST",
