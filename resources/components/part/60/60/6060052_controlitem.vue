    ...
    itemControlHeader() {
      ...
      head1 = [				
        ...
        },
        {
          ...
          {
          dataField:"TAC_CRGOODSRTN_PK", allowEditing:true,
          width:0,
          caption: this.$t('TAC_CRGOODSRTN_PK')
        },
          {
  ...
  methods: {
    ...
    onSelectItemAccount(item){
      ...
      if(itemAccIdx > -1){
        ...
        this.listCrtItem[itemAccIdx].TAC_CRGOODSRTN_PK = this.txtCrca_Pk
      }
    ...
    callBackDynamicDialog(item) {
      ...
      if(this.selectedRow !== undefined)
      {
        ...
        if (idx > -1) {
          ...
          TAC_CRGOODSRTN_PK: this.txtCrca_Pk
    ...
    async getAcntIDList(paras) {
      const dso = {
        type: "grid",
        selpro: "AC_SEL_6060052_TAC_CRGOODSRTND_CTRLITEM_NOCACHE",
    ...
    async saveMaster() {
      ...
      if(dataIsModified) {
        const dso = { 
          type: 'grid',
          selpro: 'AC_SEL_6060052_TAC_CRGOODSRTND_CTRLITEM_NOCACHE',
          updpro: 'AC_UPD_6060052_TAC_CRGOODSRTND_CTRLITEM',
          para: [ this.txtCrca_Pk ],
          elname: [ '_rowstatus', 'PK', 'TAC_ABITEM_PK', 'IN_TYPE', 'DATA_TYPE','ITEM', 'TAC_CRGOODSRTN_PK','ITEM_TABLE_PK','ITEM_NM_1' ],
