      ...
      for (let j = 0; j < einvoiceDetailData.length; j++) {
        try {
          ...
          detailCellFormat.forEach((e, i) => {
            ...
            worksheet.getCell(`${excCols[e.startCell] + rownum}`).style.border = { bottom: { style: detailCellFormat[i].cellBorder }, left: { style: "thin" }, right: { style: "thin" } };
          });
