...
class EiExcelHandler {
  ...
  async getEinvoice(pk, p_language, p_crt_by, _db2 = "N") {
    try {
      ...
      const einvoiceMasterData = await DBService.callProcCursor("EI_SEL_EINVOICE_M_WT_04SS", [pk], p_language, p_crt_by, _db2);
      ...
      const einvoiceDetailData = await DBService.callProcCursor("EI_SEL_EINVOICE_D_WT_04SS", [pk], p_language, p_crt_by, _db2);
