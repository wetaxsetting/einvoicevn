<template>
  <v-dialog id="biz-place-ei-dialog" max-width="1000" v-model="dialogIsShow">
    <v-card>
      <v-card-title class="headline primary-gradient white--text py-2">
        <span>{{ $t("biz_place_ei_list", "common") }}</span>
        <v-spacer></v-spacer>
...
export default {
  ...
  methods: {
    ...
    async onSearch() {
      const dso = {
        type: "grid",
        selpro: "AC_SEL_8015010_BPL_EI_UP",
        para: [
