...
const EiExcelConverter = use('App/Helpers/EiWTExcel04SS_BBConverter');
class EiExcelHandler {
  ...
  async getEinvoice(tei_einvoice_m_pk, p_language, p_crt_by, _db2 = 'N') {
    try {
      ...
      const einvoiceMasterData = await DBService.callProcCursor('EI_SEL_WT_04SS_BB_M', [tei_einvoice_m_pk], p_language, p_crt_by, _db2);
      // console.log("file: EiWTExcel04SS_BBHandler.js:59 [vng-304] EiExcelHandler [vng-304] getEinvoice [vng-304] einvoiceMasterData:", einvoiceMasterData)
      const einvoiceDetailData = await DBService.callProcCursor('EI_SEL_WT_04SS_BB_D', [tei_einvoice_m_pk], p_language, p_crt_by, _db2);
      // console.log("file: EiWTExcel04SS_BBHandler.js:66 [vng-304] EiExcelHandler [vng-304] getEinvoice [vng-304] einvoiceDetailData:", einvoiceDetailData)
      ...
      reportPath = 'report/60/95/ex_04ss/HD_WT_04SS_5.xlsx';
      reportSheet = 'Invoice';
