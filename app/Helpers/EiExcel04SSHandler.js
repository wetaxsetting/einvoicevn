...
class EiExcelHandler {
  ...
  async getEinvoice(pk, p_language, p_crt_by, _db2 = "N") {
    try {
      ...
      console.log("file: EiExcel04SSHandler.js:45 [vng-304] EiExcelHandler [vng-304] getEinvoice [vng-304] einvoiceMasterData:", einvoiceMasterData)

      const einvoiceDetailData = await DBService.callProcCursor("AC_SEL_EINVOICE_D_04SS", [pk], p_language, p_crt_by, _db2);
      console.log("file: EiExcel04SSHandler.js:48 [vng-304] EiExcelHandler [vng-304] getEinvoice [vng-304] einvoiceDetailData:", einvoiceDetailData)

      const einvoiceMasterParam = await DBService.callProcCursor("AC_SEL_EINVOICE_M_04SS_PARAM", [pk], p_language, p_crt_by, _db2);
      console.log("file: EiExcel04SSHandler.js:51 [vng-304] EiExcelHandler [vng-304] getEinvoice [vng-304] einvoiceMasterParam:", einvoiceMasterParam)

      const einvoiceDetailsParam = await DBService.callProcCursor("AC_SEL_EINVOICE_D_04SS_PARAM", [pk], p_language, p_crt_by, _db2);
      console.log("file: EiExcel04SSHandler.js:54 [vng-304] EiExcelHandler [vng-304] getEinvoice [vng-304] einvoiceDetailsParam:", einvoiceDetailsParam)
      ...
      for(let i = 0; i < einvoiceMasterParam.length; i++)
          ...
          // console.log("file: EiExcel04SSHandler.js:69 [vng-304] EiExcelHandler [vng-304] getEinvoice [vng-304] einvoiceDetailsParam:", einvoiceDetailsParam)
          ...
          detailCellFormat = [
            { startCell: 2, endCell: 3, cellType: 2, cellBorder: "dotted", field: "04SS_STT" },//từ cell bắt đầu tới cell kết thúc, type 2: cell đầu tiên
            { startCell: 4, endCell: 6, cellType: 1, cellBorder: "dotted", field: "04SS_MCQTCAP" },//từ cell bắt đầu tới cell kết thúc, type 3: cell kế tiếp cell đầu tiên,

            { startCell: 7, endCell: 7, cellType: 1, cellBorder: "dotted", field: "04SS_KHHDON" },//type 1: còn lại
            { startCell: 8, endCell: 8, cellType: 1, cellBorder: "dotted", field: "04SS_SHDON" },//type 1: còn lại
            //{ startCell: 13, endCell: 14, cellType: 1, cellBorder: "dotted", field: "BLANK" },//type 1: còn lại
            { startCell: 9, endCell: 9, cellType: 1, cellBorder: "dotted", field: "04SS_NGAY" },//type 1: còn lại
            //{ startCell: 17, endCell: 1, cellType: 1, cellBorder: "dotted", field: "BLANK" },//type 1: còn lại
            { startCell: 10, endCell: 10, cellType: 1, cellBorder: "dotted", field: "04SS_LADHDDT" },//type 1: còn lại
            // { startCell: 21, endCell: 22, cellType: 1, cellBorder: "dotted", field: "BLANK" },//type 1: còn lại
            { startCell: 11, endCell: 11, cellType: 1, cellBorder: "dotted", field: "04SS_TCTBAO" },
            // { startCell: 21, endCell: 22, cellType: 1, cellBorder: "dotted", field: "BLANK" },//type 1: còn lại
            { startCell: 12, endCell: 12, cellType: 3, cellBorder: "dotted", field: "04SS_LDO" },
          ]
      ...
      //     if (convertYn == "Y") {
            //  url_file_excel;//'report/60/95/einvoices_template/Bornga/Bornga.xlsx'
      //       reportSheet = "Invoice"
      ...
      reportPath = einvoiceMasterData[0].URL_FILE_EXCEL_C_IMP;
      console.log("file: EiExcel04SSHandler.js:214 [vng-304] EiExcelHandler [vng-304] getEinvoice [vng-304] reportPath:", reportPath)

      reportSheet = "Invoice";
      resultExcel = await exceljs.ExcelBuilder(p_crt_by, einvoiceMasterData, einvoiceDetailData , reportPath, reportSheet , detailCellFormat, this.masterDataArray);
