...
Route.group(() => {
    ...
    Route.post("check-notification-status", "EInvoiceController.weTaxCheckingDeclarations")
    ...
    Route.post("send-invoice", "EInvoiceController.weTaxSendPosInvoiceToTaxOffice")
