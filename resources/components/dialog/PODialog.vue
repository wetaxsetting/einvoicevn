            ...
            <v-container>
              <v-row dense align="start" justify="center">
                <v-col lg="1" class="pt-0" align="left">
                  <v-select v-model="model_search.v_typeDate" :label="$t('factory_name')" :items="dataList.lstTypeDate" item-value="CODEKEY" item-text="CODEDESC" 
                ...
                <v-col lg="2" md="3" class="pt-0">
                  <v-text-field :label="$t('so_po_item')" v-model="model_search.v_partner"  clearable dense hide-details outlined  /> 
                </v-col>
                <v-col lg="2" md="3" class="pt-0">
                  <v-text-field :label="$t('so_po_item')" v-model="model_search.v_partner"  clearable dense hide-details outlined  /> 
                </v-col>
