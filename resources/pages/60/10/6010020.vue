...
export default {
  ...
  components: {
    ...
    DeleteDialog,
    CompanyDialog,
    BizCenterDialog: () => import("@/components/dialog/BizPlaceDialog"),
  },
  ...
  methods: {
    ...
    //   const dso = {
    //     type: "grid",
    //     selpro: "ac_sel_6010020_compbyuser_v2",
    //     para: pa //type array[]
    //   };
    ...
    //     type: "grid",
    //     selpro: "ac_sel_6010020_compbyuser_v2",
    //     updpro: "ac_upd_6010020_compbyuser_v2",
    //     para: [
    ...
    openDeleteDialog() {
      ...
      // this.deleteProps = {
      //   proc: "ac_upd_6010020_companybyuser",
