      ...
      <v-col cols="12">
        ...
        <v-row align="center" justify="center">
          ...
          <DataGridView column-resizing-mode="widget" 
              ...
              sel_procedure="AC_SEL_6060010_TAC_CRCAD"
  ...
  methods: 
  {
    ...
    onGetDataWH(item){
     ...
     async getListCodes() {
          ...
          const dso_uom = { type: 'list', selpro: 'LG_LST_UOM', para: [this.lstCompany] }
   ...
   async onSaveMaster() {
    ...
    checkUpdatedItem(data) {
      ...
      if(data.data.U_PRICE != "" && data.data.QTY  != "")  
      {
