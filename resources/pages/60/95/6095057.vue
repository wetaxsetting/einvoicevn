          ...
          <v-col>
            <BaseGridView
              ...
              :update_paras="[
                ...
                'NUM_OF_PAGE',
                'NUM_OF_MORE_PAGE',
                'NUM_OF_MORE_PAGE_MAX',
                'TAX_SIGN_BY_START_CELL',
                'TAX_SIGN_BY_END_CELL',
                'TAX_SIGN_START_CELL',
                'TAX_SIGN_END_CELL',
                'TAX_SIGN_CELL_BOX',
              ]"
          ...
          <v-row lg="12">
            <v-col>
              <BaseGridView
                ...
                :header="grdParamM"
                sel_procedure="EI_SEL_6095057_5_NC"
                upd_procedure="EI_UPD_6095057_6"
                :editable="true"
  ...
  computed: {
    ...
    grdTemplate() {
      return [
        ...
        {
          dataField: "TAX_SIGN_START_CELL",
          width: 150,
          caption: this.$t("tax_sign_start_cell"),
          alignment: "left",
          type: "number",
          formatFloat: 0,
          editable: true,
        ...
        {
          dataField: "TAX_SIGN_END_CELL",
          width: 150,
          caption: this.$t("tax_sign_end_cell"),
          alignment: "left",
          type: "number",
          formatFloat: 0,
          editable: true,
        ...
        {
          dataField: "TAX_SIGN_BY_START_CELL",
          width: 160,
          caption: this.$t("tax_sign_by_start_cell"),
          alignment: "left",
          type: "number",
          formatFloat: 0,
          editable: true,
        ...
        {
          dataField: "TAX_SIGN_BY_END_CELL",
          width: 150,
          caption: this.$t("tax_sign_by_end_cell"),
          alignment: "left",
          type: "number",
          formatFloat: 0,
          editable: true,
        ...
        {
          dataField: "TAX_SIGN_CELL_BOX",
          width: 150,
          caption: this.$t("tax_sign_cell_box"),
          alignment: "left",
          type: "text",
          // formatFloat: 0,
          editable: true,
        ...
        {
          dataField: "NUM_OF_MORE_PAGE_MAX",
          width: 150,
          caption: this.$t("num_of_more_page_max"),
          alignment: "left",
          type: "number",
          formatFloat: 0,
          editable: true,
